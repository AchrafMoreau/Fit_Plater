...
export function Types() {
  ...
  const handelEdite = (id) =>{
    ...
    setEdiOrAdd("Edite")
    setToggel(true);
    axios.get(`${import.meta.env.VITE_APP_BACKEND_HOST}/api/type/${id}`, config)
      .then(({data}) => setName(data.type))
  ...
  const handleSubmit = (e)=>{
    e.preventDefault();
    axios.put(`${import.meta.env.VITE_APP_BACKEND_HOST}/api/type/${ID}`, {type:name}, config)
      .then(({data})=> {
        // setToggel(false);
  ...
  const handelDelete = ()=>{
    axios.delete(`${import.meta.env.VITE_APP_BACKEND_HOST}/api/type/${ID}`, config)
  ...
  const handelAddSubmit = ()=>{
    axios.post(`${import.meta.env.VITE_APP_BACKEND_HOST}/api/type`,{type: name}, config)
      .then(() => window.location.reload())
      .catch((err) => console.log(err))
  }
  const handelAdd = ()=>{
